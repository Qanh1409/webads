    ...
    <div class="bg-white p-6 rounded-lg shadow-xl">
        ...
        <table class="w-full border-collapse">
            <tbody>
                ...
                <!-- City Consumption -->
                <tr>
                    <td class="py-3 px-6 border-b border-gray-300 text-gray-700 font-semibold">Mức tiêu hao trong đô thị</td>
                    <td class="py-3 px-6 border-b border-gray-300 text-gray-600">{{ $fuelConsumption->city_consumption }} L/100km</td>
                </tr>
                <!-- Highway Consumption -->
                <tr>
                    <td class="py-3 px-6 border-b border-gray-300 text-gray-700 font-semibold">Mức tiêu hao ngoài đô thị</td>
                    <td class="py-3 px-6 border-b border-gray-300 text-gray-600">{{ $fuelConsumption->hightway_consumption }} L/100km</td>
                </tr>
                <!-- Total Consumption -->
                <tr>
                    <td class="py-3 px-6 border-b border-gray-300 text-gray-700 font-semibold">Mức tiêu hao hỗn hợp</td>
