...
<div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden p-6">
    <div class="flex items-center justify-center min-h-screen">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
            <h2 class="text-2xl font-bold mb-6 text-center">Thêm dòng xe</h2>

            <form action="{{route('admin.category.create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Category Name Field -->
                <div class="mb-6">
                    <label for="category_name" class="block text-gray-700 text-sm font-bold mb-2">Tên dòng xe</label>
                    <input type="text" id="category_name" name="category_name" class="form-input w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" >
                    @error('category_name')
                ...
                <!-- Image Upload Field -->
                <div class="mb-6">
                    <label for="img_url" class="block text-gray-700 text-sm font-bold mb-2">Tải ảnh lên</label>
